...
| `ai:provider:listModels` | `electron/ipc/ai/ai.cjs:549` |
...
| `ai:testWebSearch` | `electron/ipc/ai/ai.cjs:569` |
...
| `ai:webSearch` | `electron/ipc/ai/ai.cjs:584` |
...
| `db:agentFolders:create` | `electron/ipc/data/database.cjs:933` |
| `db:agentFolders:delete` | `electron/ipc/data/database.cjs:984` |
| `db:agentFolders:list` | `electron/ipc/data/database.cjs:921` |
| `db:agentFolders:update` | `electron/ipc/data/database.cjs:956` |
...
| `db:manyAgents:create` | `electron/ipc/data/database.cjs:713` |
| `db:manyAgents:delete` | `electron/ipc/data/database.cjs:906` |
| `db:manyAgents:get` | `electron/ipc/data/database.cjs:702` |
| `db:manyAgents:list` | `electron/ipc/data/database.cjs:690` |
| `db:manyAgents:listVersions` | `electron/ipc/data/database.cjs:827` |
| `db:manyAgents:restoreVersion` | `electron/ipc/data/database.cjs:852` |
| `db:manyAgents:update` | `electron/ipc/data/database.cjs:746` |
| `db:marketplace:getAgentInstalls` | `electron/ipc/data/database.cjs:1352` |
| `db:marketplace:getTemplateMappings` | `electron/ipc/data/database.cjs:1444` |
| `db:marketplace:getWorkflowInstalls` | `electron/ipc/data/database.cjs:1398` |
| `db:marketplace:replaceAgentInstalls` | `electron/ipc/data/database.cjs:1369` |
| `db:marketplace:replaceTemplateMappings` | `electron/ipc/data/database.cjs:1460` |
| `db:marketplace:replaceWorkflowInstalls` | `electron/ipc/data/database.cjs:1415` |
| `db:mcp:getGlobalEnabled` | `electron/ipc/data/database.cjs:1288` |
| `db:mcp:list` | `electron/ipc/data/database.cjs:1241` |
| `db:mcp:replaceAll` | `electron/ipc/data/database.cjs:1252` |
| `db:mcp:setGlobalEnabled` | `electron/ipc/data/database.cjs:1300` |
...
| `db:resources:bulkDelete` | `electron/ipc/data/database.cjs:1866` |
| `db:resources:create` | `electron/ipc/data/database.cjs:265` |
| `db:resources:delete` | `electron/ipc/data/database.cjs:1682` |
| `db:resources:ensureUrl` | `electron/ipc/data/database.cjs:323` |
| `db:resources:getAll` | `electron/ipc/data/database.cjs:1669` |
| `db:resources:getBacklinks` | `electron/ipc/data/database.cjs:601` |
| `db:resources:getByFolder` | `electron/ipc/data/database.cjs:1710` |
| `db:resources:getById` | `electron/ipc/data/database.cjs:308` |
| `db:resources:getByProject` | `electron/ipc/data/database.cjs:296` |
| `db:resources:getRoot` | `electron/ipc/data/database.cjs:1723` |
| `db:resources:moveToFolder` | `electron/ipc/data/database.cjs:1809` |
| `db:resources:moveToProject` | `electron/ipc/data/database.cjs:1751` |
| `db:resources:removeFromFolder` | `electron/ipc/data/database.cjs:1845` |
...
| `db:search:unified` | `electron/ipc/data/database.cjs:1480` |
...
| `db:settings:saveAI` | `electron/ipc/data/database.cjs:669` |
| `db:settings:set` | `electron/ipc/data/database.cjs:653` |
| `db:skills:list` | `electron/ipc/data/database.cjs:1313` |
| `db:skills:replaceAll` | `electron/ipc/data/database.cjs:1324` |
...
| `db:workflowExecutions:get` | `electron/ipc/data/database.cjs:1229` |
| `db:workflowExecutions:listByWorkflow` | `electron/ipc/data/database.cjs:1215` |
| `db:workflowExecutions:save` | `electron/ipc/data/database.cjs:1185` |
| `db:workflowFolders:create` | `electron/ipc/data/database.cjs:1118` |
| `db:workflowFolders:delete` | `electron/ipc/data/database.cjs:1172` |
| `db:workflowFolders:list` | `electron/ipc/data/database.cjs:1106` |
| `db:workflowFolders:update` | `electron/ipc/data/database.cjs:1144` |
| `db:workflows:create` | `electron/ipc/data/database.cjs:1021` |
| `db:workflows:delete` | `electron/ipc/data/database.cjs:1092` |
| `db:workflows:get` | `electron/ipc/data/database.cjs:1010` |
| `db:workflows:list` | `electron/ipc/data/database.cjs:998` |
| `db:workflows:update` | `electron/ipc/data/database.cjs:1049` |
