...
> Última generación: 2026-06-20T00:06:23.466Z
...
| `db:tags:addToResource` | `electron\ipc\data\tags.cjs:78` |
| `db:tags:create` | `electron\ipc\data\tags.cjs:50` |
| `db:tags:getAll` | `electron\ipc\data\tags.cjs:20` |
| `db:tags:getByResource` | `electron\ipc\data\tags.cjs:5` |
| `db:tags:getResources` | `electron\ipc\data\tags.cjs:35` |
| `db:tags:removeFromResource` | `electron\ipc\data\tags.cjs:93` |
...
| `notebook:checkPython` | `electron\ipc\media\notebook.cjs:70` |
| `notebook:checkVenv` | `electron\ipc\media\notebook.cjs:126` |
| `notebook:createVenv` | `electron\ipc\media\notebook.cjs:90` |
| `notebook:pipInstall` | `electron\ipc\media\notebook.cjs:108` |
| `notebook:pipInstallFromRequirements` | `electron\ipc\media\notebook.cjs:162` |
| `notebook:pipList` | `electron\ipc\media\notebook.cjs:144` |
| `notebook:runPython` | `electron\ipc\media\notebook.cjs:6` |
...
| `threads:compact` | `electron\ipc\agents\threads.cjs:258` |
| `threads:delete` | `electron\ipc\agents\threads.cjs:205` |
| `threads:get-history` | `electron\ipc\agents\threads.cjs:177` |
| `threads:get-state` | `electron\ipc\agents\threads.cjs:142` |
| `threads:list` | `electron\ipc\agents\threads.cjs:99` |
| `threads:navigate-tree` | `electron\ipc\agents\threads.cjs:286` |
| `threads:update-state` | `electron\ipc\agents\threads.cjs:225` |
| `transcription:get-active` | `electron\ipc\media\transcription.cjs:400` |
| `transcription:get-permissions` | `electron\ipc\media\transcription.cjs:241` |
| `transcription:get-settings` | `electron\ipc\media\transcription.cjs:144` |
| `transcription:list-capture-sources` | `electron\ipc\media\transcription.cjs:289` |
| `transcription:request-mic` | `electron\ipc\media\transcription.cjs:258` |
| `transcription:request-screen` | `electron\ipc\media\transcription.cjs:272` |
| `transcription:resource-to-note` | `electron\ipc\media\transcription.cjs:411` |
| `transcription:session-append` | `electron\ipc\media\transcription.cjs:378` |
| `transcription:session-control` | `electron\ipc\media\transcription.cjs:389` |
| `transcription:session-start` | `electron\ipc\media\transcription.cjs:350` |
| `transcription:set-display-media-source` | `electron\ipc\media\transcription.cjs:339` |
| `transcription:set-settings` | `electron\ipc\media\transcription.cjs:153` |
