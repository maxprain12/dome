...
> Última generación: 2026-07-10T09:01:19.181Z
...
| `cloudSync:getSettings` | `electron/ipc/sync/cloud-sync.cjs:107` |
| `cloudSync:getStatus` | `electron/ipc/sync/cloud-sync.cjs:22` |
| `cloudSync:pull` | `electron/ipc/sync/cloud-sync.cjs:58` |
| `cloudSync:push` | `electron/ipc/sync/cloud-sync.cjs:45` |
| `cloudSync:setSettings` | `electron/ipc/sync/cloud-sync.cjs:126` |
| `cloudSync:startRevisionWatcher` | `electron/ipc/sync/cloud-sync.cjs:71` |
| `cloudSync:stopRevisionWatcher` | `electron/ipc/sync/cloud-sync.cjs:95` |
...
| `db:search:unified` | `electron/ipc/data/database.cjs:1848` |
