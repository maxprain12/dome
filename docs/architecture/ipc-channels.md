...
> Última generación: 2026-06-27T18:35:46.501Z
...
| `db:agentFolders:create` | `electron/ipc/data/database.cjs:1042` |
| `db:agentFolders:delete` | `electron/ipc/data/database.cjs:1093` |
| `db:agentFolders:list` | `electron/ipc/data/database.cjs:1030` |
| `db:agentFolders:update` | `electron/ipc/data/database.cjs:1065` |
| `db:chat:addMessage` | `electron/ipc/agents/chat.cjs:205` |
| `db:chat:appendTrace` | `electron/ipc/agents/chat.cjs:232` |
| `db:chat:clearSession` | `electron/ipc/agents/chat.cjs:257` |
| `db:chat:createSession` | `electron/ipc/agents/chat.cjs:49` |
| `db:chat:deleteSession` | `electron/ipc/agents/chat.cjs:288` |
...
| `db:manyAgents:create` | `electron/ipc/data/database.cjs:822` |
| `db:manyAgents:delete` | `electron/ipc/data/database.cjs:1015` |
| `db:manyAgents:get` | `electron/ipc/data/database.cjs:811` |
| `db:manyAgents:list` | `electron/ipc/data/database.cjs:799` |
| `db:manyAgents:listVersions` | `electron/ipc/data/database.cjs:936` |
| `db:manyAgents:restoreVersion` | `electron/ipc/data/database.cjs:961` |
| `db:manyAgents:update` | `electron/ipc/data/database.cjs:855` |
| `db:marketplace:getAgentInstalls` | `electron/ipc/data/database.cjs:1461` |
| `db:marketplace:getTemplateMappings` | `electron/ipc/data/database.cjs:1553` |
| `db:marketplace:getWorkflowInstalls` | `electron/ipc/data/database.cjs:1507` |
| `db:marketplace:replaceAgentInstalls` | `electron/ipc/data/database.cjs:1478` |
| `db:marketplace:replaceTemplateMappings` | `electron/ipc/data/database.cjs:1569` |
| `db:marketplace:replaceWorkflowInstalls` | `electron/ipc/data/database.cjs:1524` |
| `db:mcp:getGlobalEnabled` | `electron/ipc/data/database.cjs:1397` |
| `db:mcp:list` | `electron/ipc/data/database.cjs:1350` |
| `db:mcp:replaceAll` | `electron/ipc/data/database.cjs:1361` |
| `db:mcp:setGlobalEnabled` | `electron/ipc/data/database.cjs:1409` |
...
| `db:resources:bulkDelete` | `electron/ipc/data/database.cjs:2032` |
| `db:resources:create` | `electron/ipc/data/database.cjs:298` |
| `db:resources:delete` | `electron/ipc/data/database.cjs:1833` |
| `db:resources:ensureUrl` | `electron/ipc/data/database.cjs:372` |
| `db:resources:getAll` | `electron/ipc/data/database.cjs:1801` |
| `db:resources:getBacklinks` | `electron/ipc/data/database.cjs:684` |
| `db:resources:getByFolder` | `electron/ipc/data/database.cjs:1863` |
| `db:resources:getById` | `electron/ipc/data/database.cjs:357` |
| `db:resources:getByProject` | `electron/ipc/data/database.cjs:345` |
| `db:resources:getRoot` | `electron/ipc/data/database.cjs:1876` |
| `db:resources:listLight` | `electron/ipc/data/database.cjs:1814` |
| `db:resources:moveToFolder` | `electron/ipc/data/database.cjs:1962` |
| `db:resources:moveToProject` | `electron/ipc/data/database.cjs:1904` |
| `db:resources:removeFromFolder` | `electron/ipc/data/database.cjs:2005` |
...
| `db:resources:uploadFile` | `electron/ipc/data/database.cjs:697` |
| `db:search:unified` | `electron/ipc/data/database.cjs:1602` |
...
| `db:settings:aiProviderKeyStatus` | `electron/ipc/data/database.cjs:755` |
| `db:settings:get` | `electron/ipc/data/database.cjs:720` |
| `db:settings:saveAI` | `electron/ipc/data/database.cjs:770` |
| `db:settings:set` | `electron/ipc/data/database.cjs:736` |
| `db:skills:list` | `electron/ipc/data/database.cjs:1422` |
| `db:skills:replaceAll` | `electron/ipc/data/database.cjs:1433` |
...
| `db:workflowExecutions:get` | `electron/ipc/data/database.cjs:1338` |
| `db:workflowExecutions:listByWorkflow` | `electron/ipc/data/database.cjs:1324` |
| `db:workflowExecutions:save` | `electron/ipc/data/database.cjs:1294` |
| `db:workflowFolders:create` | `electron/ipc/data/database.cjs:1227` |
| `db:workflowFolders:delete` | `electron/ipc/data/database.cjs:1281` |
| `db:workflowFolders:list` | `electron/ipc/data/database.cjs:1215` |
| `db:workflowFolders:update` | `electron/ipc/data/database.cjs:1253` |
| `db:workflows:create` | `electron/ipc/data/database.cjs:1130` |
| `db:workflows:delete` | `electron/ipc/data/database.cjs:1201` |
| `db:workflows:get` | `electron/ipc/data/database.cjs:1119` |
| `db:workflows:list` | `electron/ipc/data/database.cjs:1107` |
| `db:workflows:update` | `electron/ipc/data/database.cjs:1158` |
...
| `email:addAccount` | `electron/ipc/integrations/email.cjs:123` |
| `email:listAccounts` | `electron/ipc/integrations/email.cjs:113` |
| `email:listEnvelopes` | `electron/ipc/integrations/email.cjs:184` |
| `email:listFolders` | `electron/ipc/integrations/email.cjs:172` |
| `email:read` | `electron/ipc/integrations/email.cjs:197` |
| `email:removeAccount` | `electron/ipc/integrations/email.cjs:135` |
| `email:reply` | `electron/ipc/integrations/email.cjs:236` |
| `email:search` | `electron/ipc/integrations/email.cjs:210` |
| `email:send` | `electron/ipc/integrations/email.cjs:223` |
| `email:testConnection` | `electron/ipc/integrations/email.cjs:160` |
| `email:updateAccountPermissions` | `electron/ipc/integrations/email.cjs:147` |
...
| `github:branches:list` | `electron/ipc/integrations/github.cjs:214` |
| `github:image:resolve` | `electron/ipc/integrations/github.cjs:402` |
| `github:issues:create` | `electron/ipc/integrations/github.cjs:267` |
| `github:issues:createComment` | `electron/ipc/integrations/github.cjs:289` |
| `github:issues:get` | `electron/ipc/integrations/github.cjs:204` |
| `github:issues:list` | `electron/ipc/integrations/github.cjs:174` |
| `github:issues:listComments` | `electron/ipc/integrations/github.cjs:278` |
| `github:issues:listMentionables` | `electron/ipc/integrations/github.cjs:311` |
| `github:issues:listTimeline` | `electron/ipc/integrations/github.cjs:300` |
| `github:issues:move` | `electron/ipc/integrations/github.cjs:252` |
| `github:issues:update` | `electron/ipc/integrations/github.cjs:239` |
| `github:milestones:create` | `electron/ipc/integrations/github.cjs:334` |
| `github:milestones:get` | `electron/ipc/integrations/github.cjs:162` |
| `github:milestones:list` | `electron/ipc/integrations/github.cjs:150` |
| `github:milestones:update` | `electron/ipc/integrations/github.cjs:322` |
| `github:releases:list` | `electron/ipc/integrations/github.cjs:226` |
...
| `github:sync:now` | `electron/ipc/integrations/github.cjs:444` |
