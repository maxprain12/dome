...
| `db:tags:addToResource` | `electron/ipc/data/tags.cjs:85` |
| `db:tags:create` | `electron/ipc/data/tags.cjs:57` |
| `db:tags:getAll` | `electron/ipc/data/tags.cjs:20` |
| `db:tags:getByResource` | `electron/ipc/data/tags.cjs:5` |
| `db:tags:getResources` | `electron/ipc/data/tags.cjs:39` |
| `db:tags:removeFromResource` | `electron/ipc/data/tags.cjs:100` |
...
| `resource:delete` | `electron/ipc/data/resources.cjs:664` |
| `resource:export` | `electron/ipc/data/resources.cjs:613` |
