...
> Última generación: 2026-07-04T10:29:48.241Z
...
| `db:agentFolders:create` | `electron/ipc/data/database.cjs:1095` |
| `db:agentFolders:delete` | `electron/ipc/data/database.cjs:1146` |
| `db:agentFolders:list` | `electron/ipc/data/database.cjs:1083` |
| `db:agentFolders:update` | `electron/ipc/data/database.cjs:1118` |
...
| `db:manyAgents:create` | `electron/ipc/data/database.cjs:875` |
| `db:manyAgents:delete` | `electron/ipc/data/database.cjs:1068` |
| `db:manyAgents:get` | `electron/ipc/data/database.cjs:864` |
| `db:manyAgents:list` | `electron/ipc/data/database.cjs:852` |
| `db:manyAgents:listVersions` | `electron/ipc/data/database.cjs:989` |
| `db:manyAgents:restoreVersion` | `electron/ipc/data/database.cjs:1014` |
| `db:manyAgents:update` | `electron/ipc/data/database.cjs:908` |
| `db:marketplace:getAgentInstalls` | `electron/ipc/data/database.cjs:1514` |
| `db:marketplace:getTemplateMappings` | `electron/ipc/data/database.cjs:1606` |
| `db:marketplace:getWorkflowInstalls` | `electron/ipc/data/database.cjs:1560` |
| `db:marketplace:replaceAgentInstalls` | `electron/ipc/data/database.cjs:1531` |
| `db:marketplace:replaceTemplateMappings` | `electron/ipc/data/database.cjs:1622` |
| `db:marketplace:replaceWorkflowInstalls` | `electron/ipc/data/database.cjs:1577` |
| `db:mcp:getGlobalEnabled` | `electron/ipc/data/database.cjs:1450` |
| `db:mcp:list` | `electron/ipc/data/database.cjs:1403` |
| `db:mcp:replaceAll` | `electron/ipc/data/database.cjs:1414` |
| `db:mcp:setGlobalEnabled` | `electron/ipc/data/database.cjs:1462` |
| `db:projects:create` | `electron/ipc/data/database.cjs:202` |
| `db:projects:deleteWithContent` | `electron/ipc/data/database.cjs:291` |
| `db:projects:getAll` | `electron/ipc/data/database.cjs:225` |
| `db:projects:getById` | `electron/ipc/data/database.cjs:237` |
| `db:projects:getDeletionImpact` | `electron/ipc/data/database.cjs:281` |
| `db:projects:getVaultRoot` | `electron/ipc/data/database.cjs:270` |
| `db:projects:setVaultRoot` | `electron/ipc/data/database.cjs:251` |
| `db:resources:bulkDelete` | `electron/ipc/data/database.cjs:2063` |
| `db:resources:create` | `electron/ipc/data/database.cjs:306` |
| `db:resources:delete` | `electron/ipc/data/database.cjs:1886` |
| `db:resources:ensureUrl` | `electron/ipc/data/database.cjs:399` |
| `db:resources:getAll` | `electron/ipc/data/database.cjs:1854` |
| `db:resources:getBacklinks` | `electron/ipc/data/database.cjs:737` |
| `db:resources:getByFolder` | `electron/ipc/data/database.cjs:1903` |
| `db:resources:getById` | `electron/ipc/data/database.cjs:384` |
| `db:resources:getByProject` | `electron/ipc/data/database.cjs:372` |
| `db:resources:getRoot` | `electron/ipc/data/database.cjs:1916` |
| `db:resources:listLight` | `electron/ipc/data/database.cjs:1867` |
| `db:resources:moveToFolder` | `electron/ipc/data/database.cjs:1999` |
| `db:resources:moveToProject` | `electron/ipc/data/database.cjs:1932` |
| `db:resources:removeFromFolder` | `electron/ipc/data/database.cjs:2039` |
| `db:resources:search` | `electron/ipc/data/database.cjs:660` |
| `db:resources:searchForMention` | `electron/ipc/data/database.cjs:712` |
| `db:resources:update` | `electron/ipc/data/database.cjs:481` |
| `db:resources:uploadFile` | `electron/ipc/data/database.cjs:750` |
| `db:search:unified` | `electron/ipc/data/database.cjs:1655` |
...
| `db:settings:aiProviderKeyStatus` | `electron/ipc/data/database.cjs:808` |
| `db:settings:get` | `electron/ipc/data/database.cjs:773` |
| `db:settings:saveAI` | `electron/ipc/data/database.cjs:823` |
| `db:settings:set` | `electron/ipc/data/database.cjs:789` |
| `db:skills:list` | `electron/ipc/data/database.cjs:1475` |
| `db:skills:replaceAll` | `electron/ipc/data/database.cjs:1486` |
...
| `db:workflowExecutions:get` | `electron/ipc/data/database.cjs:1391` |
| `db:workflowExecutions:listByWorkflow` | `electron/ipc/data/database.cjs:1377` |
| `db:workflowExecutions:save` | `electron/ipc/data/database.cjs:1347` |
| `db:workflowFolders:create` | `electron/ipc/data/database.cjs:1280` |
| `db:workflowFolders:delete` | `electron/ipc/data/database.cjs:1334` |
| `db:workflowFolders:list` | `electron/ipc/data/database.cjs:1268` |
| `db:workflowFolders:update` | `electron/ipc/data/database.cjs:1306` |
| `db:workflows:create` | `electron/ipc/data/database.cjs:1183` |
| `db:workflows:delete` | `electron/ipc/data/database.cjs:1254` |
...
| `social:accounts:list` | `electron/ipc/integrations/social.cjs:116` |
| `social:connect-oauth` | `electron/ipc/integrations/social.cjs:117` |
| `social:connect-token` | `electron/ipc/integrations/social.cjs:118` |
| `social:disconnect` | `electron/ipc/integrations/social.cjs:122` |
| `social:media:library` | `electron/ipc/integrations/social.cjs:179` |
| `social:media:pick` | `electron/ipc/integrations/social.cjs:154` |
| `social:media:preview` | `electron/ipc/integrations/social.cjs:199` |
| `social:metrics:post` | `electron/ipc/integrations/social.cjs:221` |
| `social:metrics:refresh` | `electron/ipc/integrations/social.cjs:222` |
| `social:oauth:cancel` | `electron/ipc/integrations/social.cjs:121` |
| `social:oauth:set-port` | `electron/ipc/integrations/social.cjs:110` |
| `social:posts:create` | `electron/ipc/integrations/social.cjs:136` |
| `social:posts:delete` | `electron/ipc/integrations/social.cjs:146` |
| `social:posts:get` | `electron/ipc/integrations/social.cjs:131` |
| `social:posts:list` | `electron/ipc/integrations/social.cjs:128` |
| `social:posts:publish` | `electron/ipc/integrations/social.cjs:151` |
| `social:posts:update` | `electron/ipc/integrations/social.cjs:141` |
| `social:providers:set-config` | `electron/ipc/integrations/social.cjs:105` |
| `social:providers:status` | `electron/ipc/integrations/social.cjs:95` |
| `social:summary` | `electron/ipc/integrations/social.cjs:223` |
