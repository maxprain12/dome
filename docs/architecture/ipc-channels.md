...
| `db:agentFolders:create` | `electron/ipc/data/database.cjs:1038` |
| `db:agentFolders:delete` | `electron/ipc/data/database.cjs:1089` |
| `db:agentFolders:list` | `electron/ipc/data/database.cjs:1026` |
| `db:agentFolders:update` | `electron/ipc/data/database.cjs:1061` |
...
| `db:settings:aiProviderKeyStatus` | `electron/ipc/data/database.cjs:751` |
| `db:settings:get` | `electron/ipc/data/database.cjs:716` |
| `db:settings:saveAI` | `electron/ipc/data/database.cjs:766` |
| `db:settings:set` | `electron/ipc/data/database.cjs:732` |
| `db:skills:list` | `electron/ipc/data/database.cjs:1418` |
| `db:skills:replaceAll` | `electron/ipc/data/database.cjs:1429` |
...
| `db:workflowExecutions:get` | `electron/ipc/data/database.cjs:1334` |
| `db:workflowExecutions:listByWorkflow` | `electron/ipc/data/database.cjs:1320` |
| `db:workflowExecutions:save` | `electron/ipc/data/database.cjs:1290` |
| `db:workflowFolders:create` | `electron/ipc/data/database.cjs:1223` |
| `db:workflowFolders:delete` | `electron/ipc/data/database.cjs:1277` |
| `db:workflowFolders:list` | `electron/ipc/data/database.cjs:1211` |
| `db:workflowFolders:update` | `electron/ipc/data/database.cjs:1249` |
| `db:workflows:create` | `electron/ipc/data/database.cjs:1126` |
| `db:workflows:delete` | `electron/ipc/data/database.cjs:1197` |
| `db:workflows:get` | `electron/ipc/data/database.cjs:1115` |
| `db:workflows:list` | `electron/ipc/data/database.cjs:1103` |
| `db:workflows:update` | `electron/ipc/data/database.cjs:1154` |
