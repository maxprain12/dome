...
| `social:metrics:post` | `electron/ipc/integrations/social.cjs:288` |
| `social:metrics:refresh` | `electron/ipc/integrations/social.cjs:289` |
| `social:metrics:refreshPost` | `electron/ipc/integrations/social.cjs` |
| `social:oauth:cancel` | `electron/ipc/integrations/social.cjs:144` |
| `social:oauth:set-port` | `electron/ipc/integrations/social.cjs:133` |
| `social:posts:create` | `electron/ipc/integrations/social.cjs:162` |
| `social:posts:delete` | `electron/ipc/integrations/social.cjs:195` |
...
| `social:reports:config:get` | `electron/ipc/integrations/social.cjs:313` |
| `social:reports:config:set` | `electron/ipc/integrations/social.cjs:314` |
| `social:reports:delete` | `electron/ipc/integrations/social.cjs:308` |
| `social:reports:generate` | `electron/ipc/integrations/social.cjs:303` |
| `social:reports:get` | `electron/ipc/integrations/social.cjs:298` |
