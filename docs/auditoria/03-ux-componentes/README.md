...
- Mezcla histórica Mantine/`DomeButton`: resuelta. Hoy: shadcn `Button` + `DetailModal` + `ListState`.
...
|-------|-----------|----------|--------|
| [T01 — Consolidar modales en DomeModal](T01-consolidar-modales.md) | P1 | L | ✅ Superado (`DetailModal`) |
| [T02 — Refactor de componentes gigantes](T02-refactor-componentes-gigantes.md) | P1 | L | ⬜ Pendiente |
| [T03 — Accesibilidad (aria, roles, focus)](T03-accesibilidad.md) | P2 | M | ✅ Implementada |
| [T04 — Navegación por teclado en el shell](T04-navegacion-teclado-shell.md) | P2 | M | ✅ Implementada |
| [T05 — Unificar botones (Mantine → DomeButton)](T05-unificar-botones.md) | P2 | M | ✅ Superado (shadcn `Button`) |
...
- Estados de carga/vacío/error centralizados: `ListState` (`role="status"`, `aria-live="polite"`).
- Botones: `@/components/ui/button`. Detalles: `DetailModal`.
