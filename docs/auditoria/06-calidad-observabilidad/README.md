...
| [T04 — Auditoría continua de dependencias](T04-auditoria-dependencias.md) | P3 | S | 🔶 Parcial |

> **Validación 2026-06-10**: T01 — CI ejecuta `test:security` (30 tests, 7 suites) + agent-core (39 tests) + `pnpm audit`; todo en verde en local. T02 — logger con archivo+rotación en userData/logs, masking de secretos y captura de uncaught/unhandled (4 tests). T04 — audit en CI y nota de revisión de deps escrita; falta Renovate/Dependabot.
