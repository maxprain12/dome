  ...
  "mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        icon: "flex size-10 shrink-0 items-center justify-center rounded-full bg-brand-mint text-primary [&_svg:not([class*='size-'])]:size-4",
      },
    },
    defaultVariants: {
      variant: "default",
...
function EmptyTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-brand-h3 leading-brand-h3 font-bold tracking-tight text-foreground",
        className
      )}
      {...props}
    />
