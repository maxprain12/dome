...
const Leading = defineSlot('DomeSubpageFooter.Leading');
const Trailing = defineSlot('DomeSubpageFooter.Trailing');
 ...
 */
function DomeSubpageFooter({ children, className }: DomeSubpageFooterProps) {
...
DomeSubpageFooter.Leading = Leading;
DomeSubpageFooter.Trailing = Trailing;

export default DomeSubpageFooter;
