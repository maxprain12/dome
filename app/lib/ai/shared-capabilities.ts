...
export function buildSharedResourceHint(context: SharedAgentContext): string {
  const hints: string[] = [
    ...
    'Redes sociales / Instagram / LinkedIn / X / Twitter / social media: call social_accounts_list first, then social_posts_list and/or social_metrics_summary. Requires accounts connected in the Social tab — never answer from library search or memory alone.',
  ];
