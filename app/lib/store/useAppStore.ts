...
interface AppState {
  ...
  sidebarOpen: boolean;
  toggleSidebar: () => void;
  homeSidebarSection: 'library' | 'flashcards' | 'chat' | 'projects' | 'recent' | 'tags' | 'studio' | 'agents' | `agent:${string}`;
  setHomeSidebarSection: (section: 'library' | 'flashcards' | 'chat' | 'projects' | 'recent' | 'tags' | 'studio' | 'agents' | `agent:${string}`) => void;
