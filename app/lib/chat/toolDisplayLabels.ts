...
const TOOL_LABELS_FALLBACK: Record<string, string> = {
  ...
  start_async_subagent_task: 'Iniciando subagente en segundo plano',
  check_async_subagent_task: 'Comprobando tarea en segundo plano',
  update_async_subagent_task: 'Actualizando tarea en segundo plano',
  cancel_async_subagent_task: 'Cancelando tarea en segundo plano',
  list_async_subagent_tasks: 'Listando tareas en segundo plano',
