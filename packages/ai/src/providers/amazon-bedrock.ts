...
import type { BuildHandler, BuildHandlerArguments, BuildMiddleware, DocumentType, MetadataBearer } from "@smithy/types";
...
function addCustomHeadersMiddleware(client: BedrockRuntimeClient, headers: Record<string, string>): void {
	const middleware: BuildMiddleware<object, MetadataBearer> = (next: BuildHandler<object, MetadataBearer>) => async (args: BuildHandlerArguments<object>) => {
