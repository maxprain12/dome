...
const ALLOWED_CHANNELS = {
  ...
  invoke: [
    ...
    'db:marketplace:replaceWorkflowInstalls',
    'db:marketplace:getTemplateMappings',
    'db:marketplace:replaceTemplateMappings',
    ...
    'artifact:exportHtml',
    'artifact:import',
    'artifact:frame:register',
    'artifact:frame:release',
    // Social hub (LinkedIn / Instagram / X)
    'social:providers:status',
    'social:providers:set-config',
    'social:oauth:set-port',
    'social:oauth:cancel',
    'social:accounts:list',
    'social:connect-oauth',
    'social:connect-token',
    'social:linkedin:sync-orgs',
    'social:disconnect',
    'social:posts:list',
    'social:posts:get',
    'social:posts:create',
    ...
    'social:posts:sync',
    'social:instagram:searchLocations',
    ...
    'social:reports:list',
    'social:reports:get',
    'social:reports:generate',
    'social:reports:delete',
    'social:reports:config:get',
    'social:reports:config:set',
    'social:media:pick',
    ...
    'social:event-cards:get',
    'social:event-cards:create',
    'social:event-cards:update',
    'social:event-cards:publish',
    'social:event-cards:archive',
    'social:event-cards:metrics',
    'social:event-cards:export',
    'social:event-updates:list',
    'social:event-updates:create',
    'social:event-updates:update',
    'social:event-updates:cancel',
    'social:dm-rules:list',
    'social:dm-rules:create',
    'social:dm-rules:update',
    'social:dm-rules:delete',
    'social:public:resolve',
    'social:references:list',
    'social:references:get',
    'social:references:capture',
    'social:references:delete',
    'social:collections:list',
    'social:collections:create',
    'social:collections:add',
    'social:collections:remove',
    'social:watchlists:list',
    'social:watchlists:create',
    'social:watchlists:add-member',
    'social:watchlists:remove-member',
    'social:campaigns:references:list',
    'social:campaigns:references:link',
    'social:campaigns:references:unlink',
    'social:trends:snapshot',
    'social:trends:list',
    'social:trends:feed',
    'social:trends:event',
    'social:trends:create-from',
    'social:trends:capabilities',
    'social:reports:competitive',
    'social:insights:snapshot',
    'social:explorations:list',
    'social:explorations:run',
    'social:explorations:run-theme',
    'social:explorations:cancel',
    'social:explorations:recipes',
    'social:explorations:recipes:set',
    'social:suggestions:list',
    'social:suggestions:refresh',
    'social:suggestions:accept',
...
const electronHandler = {
  ...
  calendar: {
    ...
    getEvent: (eventId) => ipcRenderer.invoke('calendar:getEvent', eventId),
  ...
  people: {
    ...
    ingest: (payload) => ipcRenderer.invoke('people:ingest', payload),
