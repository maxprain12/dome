...
const bundledCatalog = require('../marketplace/marketplace-bundled-catalog.cjs');
const marketplaceIpc = require('../ipc/integrations/marketplace.cjs');
const marketplaceConfig = require('../marketplace/marketplace-config.cjs');
